//! Driver for the LTC2941 Coloumb Counter
//!
...
impl<'a> Driver for LTC2941Driver<'a> {
    ...
    fn command(&self, command_num: usize, data: usize, _: AppId) -> isize {
        match command_num {
            ...
            // Get status.
            1 => (self.ltc2941.read_status() as isize) * -1,
            ...
            2 => {
                ...
                (self.ltc2941.configure(int_pin_conf, prescaler as u8, vbat_alert) as isize) * -1
            }

            // Reset charge.
            3 => (self.ltc2941.reset_charge() as isize) * -1,

            // Set high threshold
            4 => (self.ltc2941.set_high_threshold(data as u16) as isize) * -1,

            // Set low threshold
            5 => (self.ltc2941.set_low_threshold(data as u16) as isize) * -1,

            // Get charge
            6 => (self.ltc2941.get_charge() as isize) * -1,

            // Shutdown
            7 => (self.ltc2941.shutdown() as isize) * -1,
